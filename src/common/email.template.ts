...
import { generalEmailLayout, renderEmailShell } from "./emailTemplates/emailLayout";
...
export const generalTemplate = (body: string, options: EmailBrandingOptions = {}): string => {
  ...
  return renderEmailShell(body, {
    title: `${companyName} Notification`,
    logoUrl,
    footerLogoUrl,
    logoAlt: companyName,
    ...
    linkedinUrl,
    twitterUrl,
    signOffHtml: `<p style="margin:24px 0 0;">Best regards,</p>
      <p style="margin:8px 0 0;"><strong>${signOffName}</strong></p>`,
  });
};


export const generalTemplate___old = (body: string): string => generalEmailLayout(body);
...
export const verificationGeneralTemplate = (body: string): string => {
  return renderEmailShell(body, {
    ...
    signOffHtml: `<p style="margin:24px 0 0;">Warm regards,</p>
...
export const preferenceMatchingTemplate = (body: string): string =>
  renderEmailShell(body, { title: "Matching Properties for You" });
