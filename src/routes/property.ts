...
propertyRouter.get('/all', async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { page, limit, briefType } = req.query as ParamsDictionary;
    const propertys = await propertyControl.all(Number(page), Number(limit), briefType, true);
...
propertyRouter.get('/:_id', async (req: Request, res: Response, next: NextFunction) => {
  try {
...
propertyRouter.post('/search', async (req: Request, res: Response, next: NextFunction) => {
  try {
    // const { page, limit, briefType } = req.query as ParamsDictionary;
...
propertyRouter.post('/new', async (req: Request, res: Response, next: NextFunction) => {
  try {
    const {
      propertyType,
      propertyCondition,
...
propertyRouter.put('/update/:_id', async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { _id } = req.params as ParamsDictionary;
    if (!_id) {
...
propertyRouter.delete('/delete/:_id', async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { _id } = req.params as ParamsDictionary;
